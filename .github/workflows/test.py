...
real_image = tf.keras.preprocessing.image.load_img('https://github.com/sfu-cmpt340/project_02/blob/CICD/.github/workflows/real.png?raw=true', target_size=(299, 299))
real_image = np.array(real_image)

generated_image = tf.keras.preprocessing.image.load_img('https://github.com/sfu-cmpt340/project_02/blob/CICD/.github/workflows/test.png?raw=true', target_size=(299, 299))
